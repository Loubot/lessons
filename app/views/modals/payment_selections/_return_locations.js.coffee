...
$('.display_teachers_location').append """
    ...
    <%= j(select 'teachers_locations', 'id', content_tag(:option,'select location...',:value=>"")+options_from_collection_for_select(@locations,'id','name'), {}, { class: 'form-control teachers_location_selection' }) %>
