...
lpMTagConfig.loadTag = function () {
    ...
    for (var a = b.HumanClickRedirectOrgSite, b = b.HumanClickRedirectDestSite, c = ["lpTagSrv", "lpServer", "lpNumber", "deploymentID"], d = !0, e = 0; e < c.length; e++) 
    lpMTagConfig[c[e]] || (d = !1, typeof console != "undefined" && console.log && console.log("LivePerson : lpMTagConfig." + c[e] + " is required and has not been defined before lpMTagConfig.load()."));
...
function lpAddVars(a, b, c) {
    lpMTagConfig.vars = lpMTagConfig.vars || []; lpMTagConfig.vars.push([a, b, c])
};

	lpMTagConfig.lpTagSrv = "sr4.liveperson.net"; lpMTagConfig.lpServer = "server.lon.liveperson.net"; 
	lpMTagConfig.lpNumber = "48759847";

	if (typeof(lpUnit)=='undefined') { var lpUnit='rbs-contactus'; }
